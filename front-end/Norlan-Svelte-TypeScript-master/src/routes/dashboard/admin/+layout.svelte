<script lang="ts">
	...
	$effect(() => {
		...
		userEmail = localStorage.getItem('userEmail') || 'admin@norlan.it';
		...
		<header class="h-20 bg-white border-b border-gray-100 flex items-center justify-between px-10 shrink-0 sticky top-0 z-40">
			...
			<div class="flex items-center gap-6">
				...
				<button class="relative p-2 text-gray-400 hover:text-[#1B4B6B] transition-colors">
					...
					<span class="absolute top-1 right-1 w-4 h-4 bg-red-600 border-2 border-white rounded-full text-[10px] text-white flex items-center justify-center font-bold">3</span>
