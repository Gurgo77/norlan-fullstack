    ...
    {#if !selectedDocente}
        <div class="mb-6 md:mb-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div>
                ...
                <p class="text-gray-500 font-bold uppercase text-[10px] md:text-xs tracking-tighter">Gestione formatori e specialisti NorLan.</p>
            </div>
            <button
                    onclick={apriModaleRegistrazione}
                    class="w-full md:w-auto justify-center bg-white text-[#1B4B6B] border-2 border-[#1B4B6B] px-8 py-3.5 rounded-xl font-extrabold uppercase text-xs shadow-lg transition-all flex items-center gap-3 hover:bg-[#1B4B6B] hover:text-white"
            >
